(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/game/car.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '0396baqIXFJY6t/bMDVO3ZL', 'car', __filename);
// script/game/car.js
...
cc.Class({
    ...
    start: function start() {
        var boomNode = cc.find("boom", this.node);
    ...
    setCarTag: function setCarTag(value) {
        this.carTag = value + 1;
    },
    setCarIndex: function setCarIndex(index) {
        this.carIndex = index;
    ...
    setCanMove: function setCanMove(value) {
        this.canMove = value;
    },
    changeX: function changeX(value) {
        if (this.canMove == false) return;
        this.node.x += value;
    },
    getSpeedMax: function getSpeedMax() {
        return this._speedMax;
    },
    setSpeedMax: function setSpeedMax() {
        this._speedMax = this.gears[MAX_GEAR - 4];
    },
    setSpeedUpMax: function setSpeedUpMax() {
        this._speedMax = this.gears[this.gears.length - 1];
    },
    setCanChangeLane: function setCanChangeLane(value) {
        this.canChangeLane = value;
    },
    getCanChangeLane: function getCanChangeLane() {
        return this.canChangeLane;
    },
    getSpeedUpMax: function getSpeedUpMax() {
        return this.gears[this.gears.length - 1];
    },
    getGears: function getGears() {
        return this.gears;
    },
    getNowGear: function getNowGear() {
    ...
    playSmallCrashSound: function playSmallCrashSound() {
        var self = this;
        var tmpNode = cc.find("audioSmallCrash", this.node);
        tmpNode.stopAllActions();
        tmpNode.runAction(cc.sequence(cc.delayTime(0.1), cc.callFunc(function () {
            self.audioSmallCrash.play();
        })));
    },
    playBigCrashSound: function playBigCrashSound() {
        var self = this;
        var tmpNode = cc.find("audioBigCrash", this.node);
        tmpNode.stopAllActions();
        tmpNode.runAction(cc.sequence(cc.delayTime(0.1), cc.callFunc(function () {
    ...
    bomb: function bomb() {
        ...
        actions.push(cc.callFunc(function (target) {
            ...
            var boomEffect = this.node.getComponent(cc.Animation);
